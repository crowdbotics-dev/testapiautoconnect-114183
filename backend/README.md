...
## Project Structure
    ...
    ├── testapiautoconnect_114183  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_114183`
...
2. Clone this repo and `cd testapiautoconnect_114183`
